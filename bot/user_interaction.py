...
async def send_file_in_chat(file_name: str, message: types.Message):
    ...
    with open(file_path, 'rb') as file:
        await message.answer_document(file, caption=f"Here is your file: {file_name}")
